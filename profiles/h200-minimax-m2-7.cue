...
h200_minimax_m2_7: #OverlayProfile & bases.H200 & bases.MINIMAX_M2_7 & {
	...
	hw_patches: list.Concat([bases.H200.hw_patches, bases.GONKA_BASE_PATCHES, ["decode-poc-plugin", "pow-v2-decode-fields"]])
	runner_patch: "h200-minimax-decode-plugin"
	env: {
	...
	env: {
		...
		POC_DECODE_MAX_BATCH:   "584"
		POC_BATCH_SIZE_DEFAULT: "584"
	}
	env: {
