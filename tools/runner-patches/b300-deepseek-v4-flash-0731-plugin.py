"""B300 DeepSeek-V4-Flash-0731 PLUGIN-base hardcodes for MLNode runner.py.
...
def main() -> int:
    ...
    if MARKER not in src:
        sys.stderr.write(
            "ERROR: b300-deepseek-v4-flash-0731 patch: forced-args marker not found. "
    ...
    if MODULE_MARKER in src:
        ...
        sys.stderr.write(
            "ERROR: b300-deepseek-v4-flash-0731 patch: launch-module marker not "
