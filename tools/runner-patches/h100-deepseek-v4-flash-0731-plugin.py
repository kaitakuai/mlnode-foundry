"""H100 DeepSeek-V4-Flash-0731 PLUGIN-base hardcodes for MLNode runner.py.
...
Forced config — 4x H100/80 GiB: memory-tightest topology; gmu 0.85 + maxnbt 16384 is the only cell
  holding 400k inference AND PoC (experiments 2026-08/deepseek-v4-flash-0731-dspark-4xh100):
...
INJECTION_LINES = [
    "",
    "# --- Kaitaku H100-DeepSeek-V4-Flash-0731 plugin hardcodes (tools/runner-patches/h100-deepseek-v4-flash-0731-plugin.py) ---",  # noqa: E501
    "_dsv4_0731_forced = [",
    "    ('--tensor-parallel-size', '4'),",
    "    ('--gpu-memory-utilization', '0.85'),",
    ...
    "# --- end Kaitaku H100-DeepSeek-V4-Flash-0731 plugin hardcodes ---",
]
...
def main() -> int:
    ...
    if MARKER not in src:
        sys.stderr.write(
            "ERROR: h100-deepseek-v4-flash-0731 patch: forced-args marker not found. "
    ...
    if MODULE_MARKER in src:
        ...
        sys.stderr.write(
            "ERROR: h100-deepseek-v4-flash-0731 patch: launch-module marker not "
